...
namespace prj_Traveldate_Core.Controllers
{
    ...
    .ToList();
        ...
        [HttpPost]
        public IActionResult ForumAddDirectToCart(List<int> tripId)
        {
            TraveldateContext db = new TraveldateContext();
            int[] orderDetailIds=new int[tripId.Count];
            ...
            if (existCart)
            {
                ...
                orderDetailIds = orderDetailIdList.ToArray();
            }
            else
            {
            ...
            return Content(orderDetailIds.ToString());
